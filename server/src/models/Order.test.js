...
const validOrder = {
  ...
  items: [{ productId: objectId, productName: 'Test phone', variantId: objectId, unitPrice: 100, quantity: 1, emiPlanId: objectId, emiTenure: 6, emiMonthlyAmount: 20, emiInterestRate: 0, emiCashback: 0, firstPaymentAmount: 20 }],
