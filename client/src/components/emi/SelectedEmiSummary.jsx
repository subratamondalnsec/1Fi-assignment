    ...
    >
      ...
      <dl className="mt-4 grid gap-3 text-sm sm:grid-cols-2">
        <div>
          ...
          <dd className="font-semibold text-slate-900">{plan.tenure} months</dd>
        </div>
        <div>
        ...
        <div>
          ...
          <dd className="font-semibold text-slate-900">
            {formatCurrency(getFirstPaymentAmount(plan))}
          </dd>
        </div>
        <div>
          <dt className="text-slate-600">Next payment</dt>
          <dd className="font-semibold text-slate-900">
            {formatCurrency(plan.monthlyAmount)}
            <span className="block font-normal text-slate-600">
              Due {formattedNextDueDate}
            </span>
          </dd>
        </div>
        <div>
        ...
        <div>
          <dt className="text-slate-600">Remaining payments</dt>
          <dd className="font-semibold text-slate-900">
            {getRemainingInstallments(plan.tenure)}
          </dd>
        </div>
      </dl>
    </aside>
